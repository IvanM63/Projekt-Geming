...
void Engine::ScreenMenu::Init()
{
	...
	playSprite->AddAnimation("press", 15, 19);
	...
	playButton->SetPosition(game->setting->screenWidth - 412, 350);
	buttons.push_back(playButton);
	Button* tutorialButton = new Button(tutorialSprite, "tutorial");
	tutorialButton->SetPosition(game->setting->screenWidth - 412, 235);
	buttons.push_back(tutorialButton);
	Button* exitButton = new Button(exitSprite, "exit");
	exitButton->SetPosition(game->setting->screenWidth - 412, 120);
