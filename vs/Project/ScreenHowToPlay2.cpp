...
//How To Play 4 Reload
	...
	rifle4Sprite->SetPosition(game->setting->screenWidth * 1 / 3 - 260, game->setting->screenHeight * 3 / 5 - 100);
	...
	player4sprite->SetPosition(game->setting->screenWidth * 1 / 3 - 260, game->setting->screenHeight * 3 / 5 - 100);
	...
	for (size_t i = 0; i < ReloadSprite.size(); i++) {
		...
		ReloadSprite[i]->SetPosition(game->setting->screenWidth * 1 / 3 - 260, game->setting->screenHeight * 4 / 5 - 30);
	...
	player5sprite->SetPosition(game->setting->screenWidth * 2 / 3 - 300, game->setting->screenHeight * 3 / 5 - 100);
	...
	enemy5sprite->SetPosition(game->setting->screenWidth * 2 / 3 - 205, game->setting->screenHeight * 3 / 5 - 100);
	...
	spriteHPbar->SetPosition(game->setting->screenWidth * 2 / 3 - 400, game->setting->screenHeight * 2 / 5 - 110);
